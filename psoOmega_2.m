function [theta_2, phi_2, omega_2] = psoOmega_2(u, IR_4, tau)
rng(0);
...
for i = 1:num_particles
    personal_best_objectives(i) = objective_function_omega_2(u, personal_best_positions(i, :), IR_4, tau);
end
...
for iteration = 1:num_iterations
    ...
    for i = 1 : num_particles
        objective_value_1 = objective_function_omega_2(u, particle_positions(i, :), IR_4, tau);
...
theta_2 = global_best_position(1);
phi_2 = global_best_position(2);
% objective_value = global_best_objective;
omega_2 = [cos(global_best_position(1)) * sin(global_best_position(2)), sin(global_best_position(1)) * sin(global_best_position(2))];
